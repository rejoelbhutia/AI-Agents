 ...
 */
export type TempoTraceAttributeValue = TempoTraceAttributeStringValue | TempoTraceAttributeIntValue | TempoTraceAttributeBoolValue;
export type TempoTraceAttribute = {
     ...
     * The value of the attribute
     */
    value: TempoTraceAttributeStringValue | TempoTraceAttributeIntValue | TempoTraceAttributeBoolValue;
};
/** @internal */
